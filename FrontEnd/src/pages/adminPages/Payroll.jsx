  ...
  return (
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
            ...
            <tbody>
              {list.map((p) => (
                <tr key={p._id} className="border-b">
                  <td className="px-4 py-2">{p.employee.employeeId}</td>
                  ...
                  <td className="px-4 py-2">{p.totalEarnings.toFixed(2)}</td>
      ...
      <div className="mt-8 bg-white p-4 shadow rounded">
        <h3 className="font-semibold mb-2">Summary for {filters.year}</h3>
        {summary ? (
          <ul className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <li>Total Pay Records: {summary.totalPayrolls}</li>
            <li>Total Earning: {summary.totalEarnings.toFixed(2)}</li>
            <li>Total Deductions: {summary.totalDeductions.toFixed(2)}</li>
            <li>Net Salary: {summary.totalNetSalary.toFixed(2)}</li>
            <li>Drafts: {summary.statusBreakdown.Draft}</li>
            <li>Processed: {summary.statusBreakdown.Processed}</li>
            <li>Paid: {summary.statusBreakdown.Paid}</li>
          </ul>
        ) : (
